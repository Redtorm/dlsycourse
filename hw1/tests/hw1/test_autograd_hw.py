...
def test_log_backward():
    gradient_check(ndl.log, ndl.Tensor(np.random.uniform(1, 2, size=(5,4,))))
    gradient_check(ndl.log, ndl.Tensor(np.random.uniform(1, 2, size=(5,))))
    
def test_exp_backward():
    gradient_check(ndl.exp, ndl.Tensor(np.random.uniform(1, 2, size=(5,4,))))
    gradient_check(ndl.exp, ndl.Tensor(np.random.uniform(1, 2, size=(5,))))

def test_relu_backward():
    gradient_check(ndl.relu, ndl.Tensor(np.random.uniform(1, 2, size=(5,4,))))
    gradient_check(ndl.relu, ndl.Tensor(np.random.uniform(1, 2, size=(5,))))
